...
int main()
{
    ...
    //   int random = rand() % 10;
    item_1.setPosition(80, rand() % 500 + 100); // установка позиции кругов на экране
    item_2.setPosition(200, rand() % 500 + 100);
    item_3.setPosition(320, rand() % 500 + 100);
    item_5.setPosition(560, rand() % 500 + 100);
    item_4.setPosition(440, rand() % 500 + 100);
